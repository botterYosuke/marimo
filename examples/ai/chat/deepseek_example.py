...
def _(mo):
    ...
    This example shows how to use [`mo.ui.chat`](https://backcast-tan.vercel.app/api/inputs/chat/?h=mo.ui.chat) to make a chatbot backed by [Deepseek](https://deepseek.com/).
    """)
    return
