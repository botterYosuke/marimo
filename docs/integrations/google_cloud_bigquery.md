...
Check out our full example using Google Cloud BigQuery [here](https://github.com/botterYosuke/marimo/blob/main/examples/cloud/gcp/google_cloud_bigquery.py)
