...
class WheelBuilderHandler(PatternMatchingEventHandler):
    patterns = [
        "*.py",
        "pyproject.toml",
    ]  # Watch for changes in Python files and config
...
if __name__ == "__main__":
    # Build wheel on startup to ensure it exists
    print("Building initial wheel...")  # noqa: T201
    subprocess.run(["uv", "build"], check=True)
    print("Initial wheel built successfully.")  # noqa: T201
