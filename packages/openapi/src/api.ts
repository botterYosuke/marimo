...
export interface components {
    schemas: {
        ...
        /** KnownUnions */
        KnownUnions: {
            command: components["schemas"]["CreateNotebookCommand"] | components["schemas"]["RenameNotebookCommand"] | components["schemas"]["CodeCompletionCommand"] | components["schemas"]["ExecuteCellsCommand"] | components["schemas"]["ExecuteScratchpadCommand"] | components["schemas"]["ExecuteStaleCellsCommand"] | components["schemas"]["DebugCellCommand"] | components["schemas"]["DeleteCellCommand"] | components["schemas"]["SyncGraphCommand"] | components["schemas"]["UpdateCellConfigCommand"] | components["schemas"]["InstallPackagesCommand"] | components["schemas"]["UpdateUIElementCommand"] | components["schemas"]["ModelCommand"] | components["schemas"]["InvokeFunctionCommand"] | components["schemas"]["UpdateUserConfigCommand"] | components["schemas"]["PreviewDatasetColumnCommand"] | components["schemas"]["PreviewSQLTableCommand"] | components["schemas"]["ListSQLTablesCommand"] | components["schemas"]["ValidateSQLCommand"] | components["schemas"]["ListDataSourceConnectionCommand"] | components["schemas"]["ListSecretKeysCommand"] | components["schemas"]["RefreshSecretsCommand"] | components["schemas"]["ClearCacheCommand"] | components["schemas"]["GetCacheInfoCommand"] | components["schemas"]["StopKernelCommand"];
            /** @enum {unknown} */
            ...
            notification: components["schemas"]["CellNotification"] | components["schemas"]["FunctionCallResultNotification"] | components["schemas"]["UIElementMessageNotification"] | components["schemas"]["ModelLifecycleNotification"] | components["schemas"]["RemoveUIElementsNotification"] | components["schemas"]["ReloadNotification"] | components["schemas"]["ReconnectedNotification"] | components["schemas"]["InterruptedNotification"] | components["schemas"]["CompletedRunNotification"] | components["schemas"]["KernelReadyNotification"] | components["schemas"]["CompletionResultNotification"] | components["schemas"]["AlertNotification"] | components["schemas"]["BannerNotification"] | components["schemas"]["MissingPackageAlertNotification"] | components["schemas"]["InstallingPackageAlertNotification"] | components["schemas"]["StartupLogsNotification"] | components["schemas"]["KernelStartupErrorNotification"] | components["schemas"]["VariablesNotification"] | components["schemas"]["VariableValuesNotification"] | components["schemas"]["QueryParamsSetNotification"] | components["schemas"]["QueryParamsAppendNotification"] | components["schemas"]["QueryParamsDeleteNotification"] | components["schemas"]["QueryParamsClearNotification"] | components["schemas"]["DatasetsNotification"] | components["schemas"]["DataColumnPreviewNotification"] | components["schemas"]["SQLTablePreviewNotification"] | components["schemas"]["SQLTableListPreviewNotification"] | components["schemas"]["DataSourceConnectionsNotification"] | components["schemas"]["ValidateSQLResultNotification"] | components["schemas"]["StorageNamespacesNotification"] | components["schemas"]["SecretKeysResultNotification"] | components["schemas"]["CacheClearedNotification"] | components["schemas"]["CacheInfoNotification"] | components["schemas"]["FocusCellNotification"] | components["schemas"]["UpdateCellCodesNotification"] | components["schemas"]["UpdateCellIdsNotification"];
        };
        /**
        ...
        ModelCommand: {
            buffers: string[];
            message: components["schemas"]["ModelUpdateMessage"] | components["schemas"]["ModelCustomMessage"];
            modelId: string;
            token?: string;
            /** @enum {unknown} */
            type: "model";
         ...
         */
        ModelLifecycleNotification: {
            message: components["schemas"]["ModelOpen"] | components["schemas"]["ModelUpdate"] | components["schemas"]["ModelCustom"] | components["schemas"]["ModelClose"];
            model_id: string;
            /** @enum {unknown} */
            op: "model-lifecycle";
        };
